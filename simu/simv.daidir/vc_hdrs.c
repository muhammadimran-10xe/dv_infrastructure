...
__attribute__((weak)) SV_STRING verdi_dump_component_interface(/* INPUT */const char* A_1, /* OUTPUT */int *A_2, /* OUTPUT */SV_STRING *A_3, /* OUTPUT */SV_STRING *A_4)
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static SV_STRING (*_vcs_dpi_fp_)(/* INPUT */const char* A_1, /* OUTPUT */int *A_2, /* OUTPUT */SV_STRING *A_3, /* OUTPUT */SV_STRING *A_4) = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_stub_initialized_ = 1;
        _vcs_dpi_fp_ = (SV_STRING (*)(const char* A_1, int* A_2, SV_STRING* A_3, SV_STRING* A_4)) dlsym(RTLD_NEXT, "verdi_dump_component_interface");
    }
    if (_vcs_dpi_fp_) {
...
__attribute__((weak)) SV_STRING verdi_upper_scope(/* INPUT */const char* A_1)
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static SV_STRING (*_vcs_dpi_fp_)(/* INPUT */const char* A_1) = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_stub_initialized_ = 1;
        _vcs_dpi_fp_ = (SV_STRING (*)(const char* A_1)) dlsym(RTLD_NEXT, "verdi_upper_scope");
    }
    if (_vcs_dpi_fp_) {
        return _vcs_dpi_fp_(A_1);
    } else {
...
void __vcs_export_dpi_dummy_references__()
{
    ...
    void (*fp1)(void) = (void (*)(void)) pli_dhier_set_label;
    fp1 = fp1;
    extern void pli_dhier_add_attribute(void);
    void (*fp2)(void) = (void (*)(void)) pli_dhier_add_attribute;
    fp2 = fp2;
    extern void pli_dhier_end_event(void);
    void (*fp3)(void) = (void (*)(void)) pli_dhier_end_event;
    fp3 = fp3;
    extern void m__uvm_report_dpi(void);
    void (*fp4)(void) = (void (*)(void)) m__uvm_report_dpi;
    fp4 = fp4;
}
